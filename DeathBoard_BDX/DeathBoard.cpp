...
void entry()
{
	...
	{
		BDX::runcmdEx(u8"scoreboard objectives add deathboard dummy ËÀÍö°ñ");
		if (DeathBoard_sidebar) BDX::runcmdEx("scoreboard objectives setdisplay sidebar deathboard descending");
	});
